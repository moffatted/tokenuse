...
- [Tool parsers](development/tools/README.md): parser contracts for Claude Code, Codex, Cursor, GitHub Copilot, Gemini, Skylark, plus opt-in subscription-quota adapters for Claude.ai and ChatGPT (Codex).
